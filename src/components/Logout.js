...
function LogoutButton() {
    ...
    <div className="text-right md:flex align-middle py-0">
    <div className="align-middle py-2">
    <h1 className="text-slate-600 text-right font-mono px-10 py-0"><b>Wallet:</b> {(chainId==="0xa869")?account.substring(0,5)+'...'+account.slice(-4):<button className="text-[red]" onClick={()=>switchNetwork("0xa869")}>Switch to Fuji!</button>}</h1>
    </div>  
